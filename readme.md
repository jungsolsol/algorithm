...
1. 결국못품
  1.1 무엇을 해결 못해서 못풀었는지 적기
  1.2 테스트 통과를 못했으면 왜 통과 못했는지 적기

2. 풀었음
  2.1 어떻게 생각해서 풀었는지 적기
  2.2 다른 사람 코드를 보면서 다른사람 코드와 내 코드와 비교
